...
class AttributeGraph:
    ...
    def construct_model(self):
        ...
        self.graph, entropy, self.adj = self.local_search()
        ...
        if self.config['init_measure'] == 0:
            ...
            measure_list = self.get_all_n_way_measure(3)
        ...
        return self.graph, self.measure_list, self.attr_list, self.attr_to_level, entropy, self.adj

...
class Corex(object):
    ...
    def __init__(self, n_hidden=2, dim_hidden=2,            # Size of representations
                 max_iter=100, n_repeat=1, ram=8., max_samples=40000, n_cpu=1,   # Computational limits
                 eps=1e-5, marginal_description='gaussian', smooth_marginals=True,    # Parameters
    ...
    def fit_transform(self, X):
        ...
        for n_rep in range(self.n_repeat):
            ...
            if self.tc > best_tc:
                ...
                # TODO: what happens if n_cpu > 1 and n_repeat > 1? Does pool get copied? Probably not...just a pointer to the same object... Seems fine.
